...
class Listify_WP_Job_Manager_Template_Filters {
	...
	public static function hooks() {
		...
		add_filter( 'job_manager_get_listings', array( __CLASS__, 'sort_listings_result' ), 10, 2 );
	...
	public static function get_filters( $display = 'home', $atts = array() ) {
		...
		$default = array( 'keyword', 'location', 'category','design_level');
	...
	public static function get_all_filters( $atts ) {
		return apply_filters(
			'listify_wp_job_manager_filters',
			array(
...
<div class="search_location">
	...
	public static function get_category_filter( $atts = array() ) {
		...
		$dropdown_args = apply_filters(
			'listify_wp_job_manager_filters_dropdown_category',
			array(
